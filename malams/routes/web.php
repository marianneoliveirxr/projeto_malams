...
Route::prefix('admin')->name('admin.')->group(function () {
     ...
     //Agendas - CRUD 
     Route::resource('agendas', AgendasDashController::class );
     Route::get('buscar-clientes', [AgendasDashController::class, 'buscarClientes']);
     Route::get('/get-servicos/{idCategoria}', [AgendasDashController::class, 'getServicos']);
     Route::get('/get-funcionarios/{servicoId}', [AgendasDashController::class, 'getFuncionarios']);
     Route::get('/get-horarios-disponiveis', [AgendasDashController::class, 'horariosDisponiveis']);
 });
...
//Rotas de agendamento de CLIENTES
...
//Rotas para meu perfil e meus agendamento - Cliente 

Route::middleware('auth')->group(function () {
    Route::get('/perfil-cliente', [PerfilClienteController::class, 'index'])->name('perfilCliente.index');
    Route::put('/perfil-cliente', [PerfilClienteController::class, 'atualizarPerfil'])->name('cliente.atualizarPerfil');
    Route::delete('/cliente-excluir', [PerfilClienteController::class, 'excluirConta'])->name('cliente.excluirConta');
});

Route::middleware(['auth'])->group(function () {
    Route::get('/agendamentos', [AgendaClienteController::class, 'index'])->name('agendamentos.index');
